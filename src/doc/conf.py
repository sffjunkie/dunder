# -*- coding: utf-8 -*-
#
# Dunder documentation build configuration file, created by
...
project = u'Dunder'
copyright = u'2014, Simon Kennedy'
...
latex_documents = [
  ('index', 'Dunder.tex', u'Dunder Documentation',
   u'Simon Kennedy', 'manual'),
]
...
man_pages = [
    ('index', 'dunder', u'Dunder Documentation',
     [u'Simon Kennedy'], 1)
]
...
texinfo_documents = [
  ('index', 'Dunder', u'Dunder Documentation',
   u'Simon Kennedy', 'Dunder', 'One line description of project.',
   'Miscellaneous'),
]
